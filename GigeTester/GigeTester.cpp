...
// GigeTester.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGigeTesterApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CGigeTesterApp

CGigeTesterApp::CGigeTesterApp()
{
...
// Единственный объект CGigeTesterApp

CGigeTesterApp theApp;


// Инициализация CGigeTesterApp

BOOL CGigeTesterApp::InitInstance()
{
