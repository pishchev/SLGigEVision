...
// GigeConfigurator.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGigeConfiguratorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CGigeConfiguratorApp

CGigeConfiguratorApp::CGigeConfiguratorApp()
{
...
// Единственный объект CGigeConfiguratorApp

CGigeConfiguratorApp theApp;


// Инициализация CGigeConfiguratorApp

BOOL CGigeConfiguratorApp::InitInstance()
{
