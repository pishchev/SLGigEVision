...
// GigePreview.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGigePreviewApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CGigePreviewApp

CGigePreviewApp::CGigePreviewApp()
{
...
// Единственный объект CGigePreviewApp

CGigePreviewApp theApp;


// Инициализация CGigePreviewApp

BOOL CGigePreviewApp::InitInstance()
{
