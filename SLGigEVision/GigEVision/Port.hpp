...
GENICAM_INTERFACE GENAPI_DECL_ABSTRACT Port : public GENAPI_NAMESPACE::IPort
{
	...
	virtual GENAPI_NAMESPACE::EAccessMode GetAccessMode() const
	{
		...
		Buffer read(10);
		elog(GCGetPortInfo(_portHandler, GenTL::PORT_INFO_ACCESS_READ, &type, (void*)read.Convert<void>(), read.Size()), "GetAccessMode");

		Buffer write(10);
		elog(GCGetPortInfo(_portHandler, GenTL::PORT_INFO_ACCESS_WRITE, &type, (void*)write.Convert<void>(), write.Size()), "GetAccessMode");

		Buffer na(10);
		elog(GCGetPortInfo(_portHandler, GenTL::PORT_INFO_ACCESS_NA, &type, (void*)na.Convert<void>(), na.Size()), "GetAccessMode");

		Buffer ni(10);
		elog(GCGetPortInfo(_portHandler, GenTL::PORT_INFO_ACCESS_NI, &type, (void*)ni.Convert<void>(), ni.Size()), "GetAccessMode");
	...
	static Buffer GetXML(GenTL::PORT_HANDLE iPort, bool& oIsZipped)
	{
		...
		elog(GCGetPortURLInfo(iPort, 0, GenTL::URL_INFO_URL, &infoCmd, (void*)info.Convert<void>(), info.Size()), "GCGetPortURLInfo");
		...
		Buffer xmlData(len);
		elog(GCReadPort(iPort, address, (void*)xmlData.Convert<void>(), xmlData.Size()), "GCReadPort");
