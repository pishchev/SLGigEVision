...
public:
	...
	std::vector<std::string> ShowStreams()
	{
		...
		{
			Buffer dsIDs(20);
			elog(DevGetDataStreamID(_deviceHandler, i, (char*)dsIDs.Convert<char>(), dsIDs.Size()), "DEV_Handler::ShowStreams");
	...
	{
		Buffer dsIDs(20);
		elog(DevGetDataStreamID(_deviceHandler, iIndex, (char*)dsIDs.Convert<char>(), dsIDs.Size()), "DEV_Handler::ShowStreams");
	...
	GenTL::DS_HANDLE GetStream(uint32_t iNum)
	{
		...
		elog(DevGetDataStreamID(_deviceHandler, iNum, (char*)dsIDs.Convert<char>(), dsIDs.Size()), "DEV_Handler::GetStream");
